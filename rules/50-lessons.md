...
（目前無——2026-09-09 封存 7 條，見 `docs/lessons-archive.md`。2026-08-23 另有兩條已升級為 `rules/20-judgment.md` §2 的補充判準並封存至 `docs/lessons-archive.md`；同日另加的兩條判準是直接從事故寫成的，未經本檔，封存檔查不到對應條目。）
